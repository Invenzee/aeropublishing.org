...
const PRIMARY_DARK = "#332C60";
const PRIMARY_SOFT = "#EDEAF5";
const PRIMARY_TINT = "#F6F4FA";
const SECONDARY = "#332C60";
const ON_PRIMARY = "#FFFFFF";
const ON_SOFT = "#111111";
const DELETE_RED = "#E96659";
const ACCENT = "#E96659";
...
const PILL_FIELD =
  "w-full rounded-full px-5 py-3 text-sm font-medium text-[#111] outline-none transition-all duration-300 placeholder:text-[#111]/60 focus:ring-2 focus:ring-[#3F3774]/25 [&:-webkit-autofill]:[-webkit-text-fill-color:#111] [&:-webkit-autofill]:[box-shadow:0_0_0_1000px_#EDEAF5_inset]";
...
function TrackedEditingSample() {
  ...
  return (
    <div className="grid items-start gap-6 min-w-0 md:gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-10">
            ...
            >
              <button
                ...
                className={`flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-[13px] font-semibold transition-colors duration-300 cursor-pointer sm:gap-4 sm:px-5 sm:py-4 sm:text-sm ${
                  isOpen ? "text-white" : "text-[#111] hover:text-[#3F3774]"
                }`}
              ...
              >
                ...
                >
                  <FaChevronDown
                    className={`h-3 w-3 ${isOpen ? "text-white" : "text-[#3F3774]"}`}
                    aria-hidden="true"
                  />
                </motion.span>
              </button>
      ...
      >
        <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-[#3F3774]">
          {stage.title}
        </p>
        ...
        <div className="mt-6 flex flex-col items-start gap-3 border-t border-black/10 pt-5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
          ...
          >
            <span
              ...
              style={{ backgroundColor: showEdits ? PRIMARY : "#C9C4E0" }}
            >
              <motion.span
          ...
          return (
            <button
              ...
              className={`shrink-0 cursor-pointer rounded-full border px-4 py-2 text-xs font-semibold transition-all duration-300 sm:px-6 sm:py-2.5 sm:text-sm ${
                isActive
                  ? "border-[#3F3774] bg-[#3F3774] text-white shadow-md"
                  : "border-[#D5D2DC] bg-white text-[#111] hover:border-[#3F3774]/30 hover:bg-[#F6F4FA]"
              }`}
            >
              {genre.label}
            </button>
...
function MidPageCta() {
  return (
    <section className="relative bg-[url('/sp-editing-lp/banner.webp')] bg-cover bg-center" aria-label="Special offer">
      <div className="absolute inset-0 bg-[#332C60]/90"></div>
  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 w-full bg-[#3F3774] shadow-sm transition-all duration-300 ${headerScrolled ? "shadow-md" : ""}`}
      >
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              <span className="hidden lg:inline-flex">
                <button
                  ...
                  className={`${BTN_BASE} shrink-0 px-5 py-2.5 text-sm text-white hover:brightness-95`}
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
              {METHODOLOGY_STEPS.map((step) => (
                ...
                >
                  ...
                  <p className="text-xs leading-relaxed text-[#4B428A] sm:text-sm">{step.body}</p>
                </article>
              ))}
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    {SOCIAL_LINKS.map((social) => (
                      <a
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#332C60] hover:text-white"
                        style={{ backgroundColor: PRIMARY }}
                      >
