...
<section className="hero" id="top">
  ...
  <div className="shell hero-art" aria-hidden="true">
    <svg viewBox="0 0 1160 200" fill="none">
      <defs>
        <linearGradient id="pg1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#4B428A"/><stop offset="100%" stopColor="#E96659"/></linearGradient>
        <linearGradient id="pg2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#332C60"/><stop offset="100%" stopColor="#3F3774"/></linearGradient>
        <linearGradient id="pg3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#FFC658"/><stop offset="100%" stopColor="#FF9A1F"/></linearGradient>
        <linearGradient id="ln" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#4B428A" stopOpacity=".7"/><stop offset="100%" stopColor="#E96659" stopOpacity=".1"/></linearGradient>
      </defs>
    ...
    <div className="dist-grid">
      <div className="dist rv">
        <div className="dist-h">
          <span className="dist-ic" style={{background: "linear-gradient(135deg,#3F3774,#E96659)"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 9h20"/></svg></span>
          <h3>Where readers buy directly</h3>
        </div>
        <ul>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#3F3774" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Amazon, print and Kindle</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#3F3774" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Barnes & Noble</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#3F3774" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Apple Books</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#3F3774" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Kobo and Google Play Books</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#3F3774" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Audible, for audiobook editions</li>
        </ul>
      </div>

      <div className="dist rv">
        <div className="dist-h">
          <span className="dist-ic" style={{background: "linear-gradient(135deg,#332C60,#7C5CFF)"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 21V8l9-5 9 5v13"/><path d="M9 21v-6h6v6"/></svg></span>
          <h3>Where stores and libraries order from</h3>
        </div>
        <ul>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#332C60" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Ingram, the wholesale catalogue buyers use</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#332C60" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Independent bookstores</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#332C60" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Public library systems</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#332C60" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Academic and school libraries</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#332C60" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Book fairs and signing events</li>
        </ul>
      </div>

      <div className="dist rv">
        <div className="dist-h">
          <span className="dist-ic" style={{background: "linear-gradient(135deg,#4B428A,#E96659)"}}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a14 14 0 010 18 14 14 0 010-18z"/></svg></span>
          <h3>How far it actually travels</h3>
        </div>
        <ul>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4B428A" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>All 50 US states</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4B428A" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>UK, Canada, Australia and EU retailers</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4B428A" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Print on demand, no warehousing for you</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4B428A" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Hardcover, paperback, ebook, audio</li>
          <li><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4B428A" strokeWidth="3" strokeLinecap="round"><path d="M4 12.5l5.5 5.5L20 6"/></svg>Author copies at printing cost</li>
        </ul>
      </div>
    </div>
...
<section className="sec sec-mist">
  <div className="shell">
    ...
    <div className="gen-grid">
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#3F3774,#E96659)"}}></i>Memoirs and biographies</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#332C60,#7C5CFF)"}}></i>Business and leadership</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#4B428A,#E96659)"}}></i>Self-help and personal growth</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#FFC658,#FF9A1F)"}}></i>Fiction, all sub-genres</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#3F3774,#E96659)"}}></i>Children's and young adult</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#332C60,#7C5CFF)"}}></i>Health and medical</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#4B428A,#E96659)"}}></i>Faith and spirituality</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#FFC658,#FF9A1F)"}}></i>Education and research</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#3F3774,#E96659)"}}></i>Finance and economics</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#332C60,#7C5CFF)"}}></i>Lifestyle and travel</div>
      <div className="gen rv"><i style={{background: "linear-gradient(135deg,#4B428A,#E96659)"}}></i>Motivational and inspirational</div>
