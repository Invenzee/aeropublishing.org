    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1140px] px-4 py-12 sm:px-6 sm:py-14 lg:px-4 lg:py-16">
        <Reveal className="max-w-[620px] rounded-[20px] bg-white/70 p-5 backdrop-blur-[2px] sm:p-6 lg:bg-transparent lg:p-0 lg:backdrop-blur-none">
          ...
          <h2 className="mt-2 font-syne text-[32px] font-semibold leading-[1.15] tracking-[-0.02em] text-[#3f3774] sm:text-[44px] lg:text-[56px]">
            Let&apos;s Bring Your
            <br />
          ...
          <a
            href="#hire-form"
            className="mt-6 inline-flex h-10 items-center justify-center rounded-full bg-[#3f3774] px-6 font-syne text-[15px] font-semibold capitalize text-white transition-all duration-300 hover:opacity-90 hover:brightness-110 active:scale-[0.98]"
          >
